...
struct OnboardingView: View {
    ...
    private var continueButton: some View {
        Button { advance() } label: {
            HStack(spacing: 8) {
                Text(currentPage == totalPages - 1 ? "See My Plan" : "Continue")
    ...
    private var recommendedPattern: BreathingPattern {
        ...
        case .anxiety: return BreathingPresets.anxietyReset
    ...
    private var personalizedSummary: String {
        ...
        return "Based on your goals, we've created a breathing plan to help you \(goalText). Here's what we recommend."
    }
...
enum PreferredTime: String, CaseIterable {
    ...
    var icon: String {
        ...
        case .whenStressed: return "heart.fill"
    ...
    var color: Color {
        ...
        case .whenStressed: return BDDesign.Colors.accentAnxiety
